...
const worldCupManagerTheme: SequenceTheme = {
  ...
  steps: [
    ...
    // Step 7: Pre-Tournament Drama
    {
      ...
      wheelConfig: {
        segments: [
          { id: 'star-injury-scare', text: 'Star Player Injury Scare', color: '#8B0000', rarity: 'common', weight: 15 },
          { id: 'captain-leadership-dispute', text: 'Captain Leadership Dispute', color: '#DC143C', rarity: 'uncommon', weight: 12 },
          { id: 'political-controversy', text: 'Political Statement Controversy', color: '#2F4F4F', rarity: 'uncommon', weight: 10 },
          { id: 'young-player-breakthrough', text: 'Young Player Breakthrough', color: '#32CD32', rarity: 'uncommon', weight: 12 },
          { id: 'media-scandal', text: 'Media Scandal Erupts', color: '#FF4500', rarity: 'rare', weight: 8 },
          { id: 'tactical-leak', text: 'Tactical Plans Leaked', color: '#9370DB', rarity: 'rare', weight: 8 },
          { id: 'squad-harmony-perfect', text: 'Perfect Squad Harmony', color: '#FFD700', rarity: 'rare', weight: 8 },
          { id: 'veteran-comeback', text: 'Veteran\'s Surprise Comeback', color: '#4169E1', rarity: 'uncommon', weight: 10 },
          { id: 'formation-revolution', text: 'Formation Revolution', color: '#FF69B4', rarity: 'uncommon', weight: 9 },
